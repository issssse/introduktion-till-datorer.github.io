---
menuTitle: Studentportalen
title: "Rättning i Studentportalen (alla utom ES)"
weight: 30
pre: <i class="fas fa-user-check"></i>
---

För alla utom ES sker inlämning och rättning av uppgifter i [Studentportalen][studentportalen]. 

[studentportalen]: https://www.studentportalen.uu.se
...
**Notera att det är inte ditt student-ID på formen `abcd1234` du loggar in med i detta fall,
...
läsas av andra lärare/lärarassistenter och administratörer.
...
Vid rättning av inlämnade uppgifter behöver inte checkrutan längst till vänster
markeras för att ändringar ska sparas. 
...
1. **Sätt status till** `Granskning pågår` för alla studenter du ska rätta **och tryck på spara**.  
   _Detta är för att övriga handledare ska se att eleven är under rättning._
...
2. För alla elever, en åt gången (se varför i [Kommentera komplettering](#kommentera-komplettering)):  
   ...
   **Om studenten är godkänd efter komplettering** sätter du status till `Klar efter komplettering`  
   _annars:_  
   **Om studenten ska komplettera** sätter du status till `Rest - Kompletteras`
